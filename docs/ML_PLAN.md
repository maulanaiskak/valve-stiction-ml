...
- `derive_label(pv_window, op_window, ellipse_threshold) -> Literal["yes", "no", "uncertain"]`: combines both; "uncertain" windows are excluded from RF training data (not imputed, not guessed). Threshold not yet tuned — see §13.
